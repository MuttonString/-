  ...
  return (
    <>
      ...
      <div className={styles.main}>
        <Form labelCol={{ span: 4 }} style={{ maxWidth: 'none' }} form={form1}>
          ...
          <Form.Item
            ...
            name="goodsAvatar"
            wrapperCol={{ span: 6 }}
            rules={[{ required: true, message: '商品头图不能为空' }]}
          >
            <Upload
              name="goodsAvatar"
          ...
          <Form.Item
            ...
            name="goodsDesc"
            wrapperCol={{ span: 8 }}
            rules={[{ required: true, message: '商品文字描述不能为空' }]}
          >
            <TextArea
              showCount
              maxLength={100}
          ...
          <Form.Item
            ...
            wrapperCol={{ span: 8 }}
            rules={[{ required: true, message: '服务保障不能为空' }]}
          >
            <TextArea
              showCount
              maxLength={100}
